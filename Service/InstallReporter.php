<?php
/**
 * Standalone install + heartbeat reporter for Panth_OrderCleanup.
 *
...
namespace Panth\OrderCleanup\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_OrderCleanup';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-order-cleanup';
